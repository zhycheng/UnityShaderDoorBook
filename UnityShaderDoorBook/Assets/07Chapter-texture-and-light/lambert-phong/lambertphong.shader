    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 abedo=tex2D(_MainTex,i.uv).xyz*_Color.xyz;
                ...
                fixed3 R=reflect(-worldLightDir,worldNormal);


                fixed3 specular=_LightColor0*abedo*pow(max(0,dot(viewDir,R)),_Gloss);      //blinn-phong
